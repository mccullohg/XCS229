...
def predict(state, kernel, x_i):
    ...
    """
    # *** START CODE HERE ***
    return sign(sum(theta * kernel(x, x_i) for theta, x in state))  # parameter notation
    # *** END CODE HERE ***
    pass
...
def update_state(state, kernel, learning_rate, x_i, y_i):
    ...
    """
    # *** START CODE HERE ***
    update = learning_rate * (y_i - predict(state, kernel, x_i))
    state.append((update, x_i))  # update features
    # *** END CODE HERE ***
    pass
